...
const char szTitle[] = "SteamBrowser";
...
public:
  ViewWin(int width, int height) {
    ...
    hwnd_ = CreateWindow((LPCSTR)szWindowClass,
              (LPCSTR)szTitle,
              WS_OVERLAPPEDWINDOW,
              CW_USEDEFAULT,
              CW_USEDEFAULT,
  ...
  static void PlatformInit() {
    ...
    wc.lpszClassName = (LPCSTR)szWindowClass;
  ...
  virtual void OnChangeTitle(Awesomium::WebView* caller,
    ...
    SetWindowText(hwnd_, (LPCSTR)title_wide.c_str());
  }
